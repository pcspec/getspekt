...
var _towerCoordsEs = require("./tower/coords.es");

var _piecePieceEs = require("./piece/piece.es");

var _pieceAnchorEs = require("./piece/anchor.es");

var _pieceIconEs = require("./piece/icon.es");

var _pieceImageEs = require("./piece/image.es");

var _pieceLabelEs = require("./piece/label.es");
...
function renderText(coords, text) {
  ...
  var size = _objectWithoutProperties(coords, ["x", "y"]);
...
// cpu
var cpu = {};
cpu = (0, _piecePieceEs.piece)({ x: 400, y: 200, w: 50, h: 50 }, cpu);
cpu = (0, _pieceIconEs.icon)({ x: 50, y: 50, w: 50, h: 50 }, cpu);
cpu = (0, _pieceLabelEs.label)(cpu);
cpu = (0, _pieceImageEs.image)(cpu);
cpu = (0, _pieceAnchorEs.anchor)(cpu, coords.tower);
...
// mobo
var mobo = {};
mobo = (0, _piecePieceEs.piece)({ x: 370, y: 180, w: 150, h: 250 }, mobo);
mobo = (0, _pieceIconEs.icon)({ x: 50, y: 250, w: 50, h: 50 }, mobo);
mobo = (0, _pieceLabelEs.label)(mobo);
mobo = (0, _pieceImageEs.image)(mobo);
mobo = (0, _pieceAnchorEs.anchor)(mobo, coords.tower);
...
function image(piece) {
  var size = arguments.length <= 1 || arguments[1] === undefined ? { w: 150, h: 150 } : arguments[1];
...
(function (glob) {
    ...
    \*/
        eve = function (name, scope) {
            ...
            stop = oldstop;
            current_event = ce;
            return out.length ? out : (function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);var f=new Error("Cannot find module '"+o+"'");throw f.code="MODULE_NOT_FOUND",f}var l=n[o]={exports:{}};t[o][0].call(l.exports,function(e){var n=t[o][1][e];return s(n?n:e)},l,l.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s})({1:[function(require,module,exports){
"use strict";
